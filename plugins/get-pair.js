...
async (conn, mek, m, { from, prefix, quoted, q, reply }) => {
    try {
        ...
        // Fetch pairing code
        //const fetch = require("node-fetch");
        const response = await fetch(`https://youngboy-pair.onrender.com/pair?phone=${q}`);
        ...
        const doneMessage = "> *TIARA-SESSION PAIR COMPLETED*";
...
async (conn, mek, m, { from, prefix, quoted, q, reply }) => {
    try {
        ...
        // Fetch pairing code
        //const fetch = require("node-fetch");
        const response = await fetch(`https://youngboy-pair.onrender.com/pair?number=${q}`);
        const pair = await response.json();
        ...
        // Success response
        const pairingCode = pair.code;
        const doneMessage = "> *TIARA-AI PAIR COMPLETED*";
